...
//        config.put(JsonSerializer.TYPE_MAPPINGS,"productCreatedEvent:com.kafka.learning.productmicroservice.service.event.ProductCreatedEvent");
    ...
    /// Создаем топик при старте приложения
    @Bean
    NewTopic createTopic(){
        return TopicBuilder.name("product-created-events-topic")
                .partitions(3)
                .replicas(3)
                /// 2 сервера должны быть в синхроне с нашим лидером
